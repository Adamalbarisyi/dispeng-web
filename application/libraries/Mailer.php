...
class Mailer {
    protected $_ci;
    protected $email_pengirim = 'akuntestsaya25@gmail.com'; // Isikan dengan email pengirim
    protected $nama_pengirim = 'Akun Test'; // Isikan dengan nama pengirim
    protected $password = 'qwertyuiop@123'; // Isikan dengan password email pengirim
    ...
    public function send($data){
        ...
        $mail->Username = 'akuntestsaya25@gmail.com'; // Email Pengirim
        $mail->Password = 'qwertyuiop@123'; // Isikan dengan Password email pengirim
        $mail->Port = 465;
        $mail->SMTPAuth = true;
        $mail->SMTPSecure = 'ssl';
