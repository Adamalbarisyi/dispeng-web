...
<!-- 
 <div class="modal fade" id="modal-detail <?php  ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                              <div class="modal-dialog" role="document">
                                <div class="modal-content">
                                  <div class="modal-header">
                                    <h5 class="modal-title" id="exampleModalLabel">Detail HUKDIS</h5>
                                  ...
                                  <div class="modal-body">
                                    ...
                                    <div class="form-group row mb-2">
                                      <label for="example-text-input" class="col-md-4 col-form-label form-control-label text-left">Nomor Surat</label>
                                      <div class="col-md-8">
                                        <input class="form-control" type="text" value="John Snow" id="example-text-input" disabled>
                                      </div>
                                    </div>
